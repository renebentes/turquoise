...
if (empty($this->items)) :
  ...
  <form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" class="form-inline" role="form">
  <?php if ($this->params->get('show_headings') || $this->params->get('filter_field') != 'hide' || $this->params->get('show_pagination_limit')) :?>
    ...
    <?php if ($this->params->get('filter_field') != 'hide') :?>
      <div class="form-group">
        ...
        <input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="form-control hasTooltip" onchange="document.adminForm.submit();" data-original-title="<?php echo JText::_('COM_CONTENT_FILTER_SEARCH_DESC'); ?>" />
      </div>
    <?php endif; ?>
